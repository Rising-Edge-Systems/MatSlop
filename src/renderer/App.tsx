...
function App(): React.JSX.Element {
  ...
  const appCtx: AppContextValue = useMemo(
    () => ({
      ...
      // US-SC03: stable callbacks (ref-based from US-SC01)
      ...
      onCallStackSelect: handleCallStackSelect,
      onAddWatch: handleAddWatch,
      onRemoveWatch: handleRemoveWatch,
      onUpdateWatch: handleUpdateWatch,
      onRefreshWatches: refreshAllWatches,
    }),
    [
      helpState.topic,
      helpState.content,
      ...
      handleDocCommand,
      handleMenuActionConsumed,
      handlePasteConsumed,
      handleHistoryChanged,
      handleCallStackSelect,
      handleAddWatch,
      handleRemoveWatch,
      handleUpdateWatch,
      refreshAllWatches,
